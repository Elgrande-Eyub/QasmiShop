...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">List Professionals</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Professionals
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="data-list-view" class="data-list-view-header">
                  ...
                  {{--   <div class="add-new-data-sidebar">
                        <form id="ajouteCategorie" class="formCategorie">
                            @csrf
                          <div class="overlay-bg"></div>
                          <div class="add-new-data">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                              <div>
                                <h4 class="text-uppercase" id="TitleCategorie">Ajoute un Taille/Poids</h4>
                              </div>
                            ...
                            <div class="data-items pb-3">
                              <input type="hidden" class="form-control" id="idCategorie" name="idCategorie">

                              <div class="data-fields px-2 mt-3">
                                <div class="row">
                                  <div class="col-sm-12 data-field-col">
                                    <label for="Categorie">Taille/Poids</label>
                                    <input type="text" class="form-control" id="Categorie" name="name">
                                  </div>
                            ...
                            <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                              <div class="add-data-btn">
                                <button type="submit" class="btn btn-primary" id="submitCategorie">Ajoute Taille/Poids</button>
                              </div>
 ...
 $(document).ready(function() {
    ...
    $(document).on('submit', '#ajouteCategorie', function(e) {
    e.preventDefault();
    var formData = new FormData(this);
    $.ajax({
      url: '/admin/produits/sizes/add',
      type: 'POST',
      data: formData,
  ...
  $('#updateForm').submit(function(e) {
    e.preventDefault();
    var formData = new FormData(this);
    var rowId = formData.get('idCategorie');

    $.ajax({
      url: '/admin/produits/categories/update/' + rowId,
      type: 'PUT',
      data: formData,
      processData: false,
      contentType: false,
  ...
  var dataListView = $(".data-list-view").DataTable({
    ...
    buttons: [
      {
        text: "<i class='feather icon-plus'></i> Ajoute Un Professionals",
        action: function() {
