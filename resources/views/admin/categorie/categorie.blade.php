...
<head>
    @include('admin.layout.head')
        ...
        <title>Categorie Management</title>
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">List Categorie</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody >
                                    ...
                                    <tr>
                                        <input class="rowID" type="hidden" value="{{ $categorie->id }}" id="rowId" name="rowId">

                                        <td></td>
                                        <td class="categorieName">{{ $categorie->categorie }}</td>
                        ...
                        <div>
                          ...
                          <div class="add-new-data">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                              <div>
                                <h4 class="text-uppercase Title">Ajoute un Categorie</h4>
                              </div>
                              ...
                              <div class="data-fields px-2 mt-3">
                                <div class="row">
                                  <div class="col-sm-12 data-field-col">
                                    <label class="categorieLabel" for="categorie">Nom de Categorie</label>
                                    <input type="text" class="form-control categorieInput" >
                                  </div>
                            ...
                            <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                              <div class="add-data-btn">
                                <button  class="btn btn-primary submitData" >Ajoute Le Categorie</button>
                              </div>
    ...
    <script src="../../../app-assets/js/admin/categorie/categorie.js"></script>
