...
<head>
    ...
    <title>Update Produit | Qasmi Dashboard</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">mise a jour Produit</h4>
                                </div>
                                        ...
                                        <form id="formData" action="#" method="post" class="form "
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-label-group position-relative has-icon-left">
                                                            <input value="{{  $produit->name }}" type="text"
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-label-group position-relative has-icon-left">
                                                            <input value="{{  $produit->type }}" type="text"
                                                                id="first-name-floating-icon" class="form-control"
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-label-group position-relative has-icon-left">
                                                            <input value="{{ $produit->expireDays }}" type="number"
                                                                id="first-name-floating-icon" class="form-control"
                                                                name="expireDays"
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-label-group position-relative has-icon-left">
                                                            <input value="{{  $produit->dateProduction }}" type="date"
                                                                id="first-name-floating-icon" class="form-control"
                                                                name="dateProduction">
                                                            <div class="form-control-position">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-label-group position-relative has-icon-left">
                                                            <input value="{{  $produit->dateExpired }}" type="date"
                                                                id="first-name-floating-icon" class="form-control"
                                                                name="dateExpired">
                                                            <div class="form-control-position">
                                                                <i class="feather  icon-package"></i>
...
--}}
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset class="form-label-group">
                                                            <textarea class="form-control"  name="PackagingDelivery" id="label-textarea" rows="3"
                                                                placeholder="Label in Textarea">{{ $produit->PackagingDelivery }}</textarea>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset class="form-label-group">
                                                            <textarea data-length=350 class="form-control char-textarea" name="preDescription" id="textarea-counter"
                                                                rows="3" placeholder="Bref Description">{{  $produit->preDescription }}</textarea>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset class="form-label-group">
                                                            <textarea class="form-control" id="label-textarea" rows="3" name="description"
                                                                placeholder="Description Detailles">{{  $produit->description }}</textarea>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset class="form-label-group">
                                                            <textarea data-length=350 class="form-control char-textarea" name="Usage" id="textarea-counter" rows="3"
                                                                placeholder="attention que l'acheteur concerne">{{  $produit->Warnings }}</textarea>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset class="form-label-group">
                                                            <textarea data-length=350 class="form-control char-textarea" name="autres" id="textarea-counter" rows="3"
                                                                placeholder="attention que l'acheteur concerne">{{  $produit->autres }}</textarea>
                                            ...
                                            <div class="col-12">
                                                <button id="submitForm" data-record-id="{{ $produit->id }}"
    ...
    <script src="../../../app-assets/js/admin/updateProduit.js"></script>
