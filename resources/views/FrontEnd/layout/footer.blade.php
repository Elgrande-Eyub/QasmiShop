            ...
            <div class="row justify-content-center" >
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow fadeIn  animated">
                        ...
                        <div class="banner-text">
                            <h3 class="icon-box-title">Bon Prix Quotidien</h3>
                            <p>Lorsque vous vous Inscrivez</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-xl-none">
                    <div class="banner-left-icon d-flex align-items-center wow fadeIn  animated">
                        ...
                        <div class="banner-text">
                            <h3 class="icon-box-title">Livraison Assure</h3>
                            <p>Dans les 30 jours</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                        <div class="logo wow fadeIn animated mb-30">
                            <a href="index.html" class="mb-15"><img style="width: 20%" src="{{ asset('assets/imgs/theme/Kasmifood-Distribution-logo-v1.png') }}" alt="logo"></a>
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{ asset('assets/imgs/theme/icons/icon-email-2.svg') }}" alt=""><strong>Email:</strong><span><a href="https://demosc.chinaz.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a3d0c2cfc6e3edc6d0d78dc0ccce">[email&#160;protected]</a></span></li>
    ...
    <div class="container pb-30 wow fadeIn animated">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">Copyright 2023 © Iker. All rights reserved.</p>
            </div>
